...
function Header() {
  return (
    <header className="sticky top-0 left-0 md:left-1/2 md:right-1/2 md:top-4 z-20 flex h-14 w-full md:w-3/4 md:-translate-x-[12.5%] bg-slate-950 items-center justify-center md:justify-between md:rounded-full md:px-24">
      <Link
        href={"#home"}
        className="group flex items-center justify-center relative h-12 w-12 hover:cursor-pointer"
      >
